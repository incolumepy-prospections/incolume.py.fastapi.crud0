...
@router.get('/', status_code=status.HTTP_202_ACCEPTED, response_model=list[schemas.UserOut], summary="List all users")
...
@router.delete('/{user_id}', status_code=status.HTTP_204_NO_CONTENT, summary="Delete an user by id")
